...
import { ScrapStatusLog, ScraperLogSchema } from './schemas/scrap-status.schema';
import { ScrapLogRecords, ScrapLogRecordsSchema } from './schemas/scrap-log-records.schema';
